        ...
        <tbody>
            ...
            if (mysqli_num_rows($result_svatby) > 0) {
                while ($row = mysqli_fetch_assoc($result_svatby)) {
                    ...
                    echo "<tr>";
                    echo "<td>" . $row['id'] . "</td>";
                    echo "<td><form '".$_SERVER['PHP_SELF']."' method='post'><input type='hidden' name='id' value='".htmlspecialchars($row['id'])."'><input type='hidden' name='atribut' value='nazev'><input type='text' name='nova_hodnota' value='" . htmlspecialchars($row['nazev']) . "'><input type='submit' value='Uložit'></form></td>";
                    echo "<td><form '".$_SERVER['PHP_SELF']."' method='post'><input type='hidden' name='id' value='".htmlspecialchars($row['id'])."'><input type='hidden' name='atribut' value='cena'><input type='number' name='nova_hodnota' value='" . htmlspecialchars($row['cena'] ). "'><input type='submit' value='Uložit'></form></td>";
                    echo "<td><form '".$_SERVER['PHP_SELF']."' method='post'><input type='hidden' name='id' value='".htmlspecialchars($row['id'])."'><input type='hidden' name='atribut' value='popis'><input type='text' name='nova_hodnota' value='" . htmlspecialchars($row['popis']) . "'><input type='submit' value='Uložit'></form></td>";
                    ...
                    echo "<td><form '".$_SERVER['PHP_SELF']."' method='post'><input type='hidden' name='id' value='".htmlspecialchars($row['id'])."'><input type='hidden' name='atribut' value='delete'><input type='submit' value='Odstranit'></form></td>";
                    echo "</tr>";
                }
            } else {
