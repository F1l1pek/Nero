        ...
        <tbody>
            ...
            if (mysqli_num_rows($result_jidla) > 0) {
                while ($row = mysqli_fetch_assoc($result_jidla)) {
                    ...
                    echo "<td><form'".$_SERVER['PHP_SELF']."' method='post'><input type='hidden' name='id_jidla' value='".htmlspecialchars($row['ID_jidla'])."'><input type='hidden' name='atribut' value='cena_s'><input type='number' name='nova_hodnota' value='" . htmlspecialchars($row['cena_s']) . "'><input type='submit' value='Uložit'></form></td>";
                    echo "<td><form'".$_SERVER['PHP_SELF']."' method='post'><input type='hidden' name='id_jidla' value='".htmlspecialchars($row['ID_jidla'])."'><input type='hidden' name='atribut' value='cena_f'><input type='number' name='nova_hodnota' value='" . htmlspecialchars($row['cena_f']) . "'><input type='submit' value='Uložit'></form></td>";
